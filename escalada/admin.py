...
from .models import User, ClassType, ClimbClass, Coupon, Lesson, MyCoupon, ClimbPassType, FreeClimb
from .forms import ClimbClassForm, LessonForm, CouponForm, MyCouponForm, FreeClimbForm
